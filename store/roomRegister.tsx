...
export const dispatchDetailInfoOpen = (value: Boolean) => {
    return {
        type: ROOM_REGISTER_DETAIL_INFO_OPEN,
        ROOM_REGISTER_DETAIL_INFO_OPEN: value,
    };
};
...
export default function reducer(state = initialState, action: any) {
    switch (action.type) {
        case ROOM_REGISTER_POSTCODE_OPEN:
            return {
                ...state,
        ...
        case ROOM_REGISTER_DETAIL_INFO_OPEN: // 상세 정보 입력 컴포넌트 열고 닫기
            return {
                ...state,
                ROOM_REGISTER_DETAIL_INFO_OPEN:
                    action.ROOM_REGISTER_DETAIL_INFO_OPEN,
            };
        default:
            return state;
    }
